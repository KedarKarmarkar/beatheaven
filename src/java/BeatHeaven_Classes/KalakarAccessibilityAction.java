...
public class KalakarAccessibilityAction extends HttpServlet {
        ...
        try {
            ...
            int i=0;
                ...
                if(status.equalsIgnoreCase("block")){
                 sql = "update kalakar set Status=3 where Id="+kalakar_id+"";
                 msg="You have been blocked from beatheaven site..";
                }else if(status.equalsIgnoreCase("unblock")){
                 sql = "update kalakar set Status=1 where Id="+kalakar_id+""; 
                ...
                response.sendRedirect("ManageKalakarAccessibility.jsp");
        } catch(Exception ex) {
            out.close();
        }
    }
