...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Institute Accessibility </title>
    <!-- Bootstrap Core CSS -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><p class="navbar-text">Logged in as <a href="EditSiteAdminProfile.jsp">BeatHeaven</a></p></li>
            ...
            <div class="container-fluid">
              <div class="row">
                  <div class="col-md-12 " ><br>
                     <div class="col-md-6 ">
                         <form action="InstituteAccessibility.jsp" method="post">
                         <% try{ %>    
                                    <center>
                                        <b>Search By:</b>&nbsp;
                    ...
                    <div class="col-md-12" >
                      ...
                      <tbody>
                        <%                               
                               String name="",address="",activities="", city="",est_date="",email="",contact="",founder="",playing_instruments="",occupation="";
                               try{                                    
                                  int  count=0,institute_id=0, status=0;
                                   ...
                                   String cur_date=gcdt.getCurDate();
                                    ...
                                    if(request.getParameter("submit").equals("Filter") && request.getParameter("criteria").equalsIgnoreCase("All")){
                                        ...
                                        sql="select * from institute where "+request.getParameter("criteria")+" ='"+request.getParameter("search_value")+"'";
                                    }
                                    rs = stmt.executeQuery(sql); 
                                    while(rs.next()){
                                        institute_id=rs.getInt("Id");
                                        count++;
                                        name=rs.getString("Name");
                                        address=rs.getString("Address");
                                        city=rs.getString("City");
                                        est_date=rs.getString("EstablishDate");
                                        ...
                                        <tr class="success">                              
                                            ...
                                            <td><%=email%></td>
                                            <td><%=contact%></td>                                            
                                            <td><% if(status==1){%><a href="InstituteAccessibilityAction?InstituteId=<%=institute_id%>&Status=block&Email=<%=email%>">Block</a>
                                                <%}else if(status==3){%><a href="InstituteAccessibilityAction?InstituteId=<%=institute_id%>&Status=unblock&Email=<%=email%>">Unblock</a>
                                                <%}else if(status==2){%><a href="InstituteAccessibilityAction?InstituteId=<%=institute_id%>&Status=approve&Email=<%=email%>">Approve</a>
                                                <%}%>
                                            </td>                                            
                                       </tr>
                                    <% }
