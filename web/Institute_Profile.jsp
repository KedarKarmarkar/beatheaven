...
<% // Set refresh, autoload time as 5 seconds
   ...
   <% }    
    ...
    if(count>0){
        ...
        index =profilepic_path.lastIndexOf("/");
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
         ...
         <!--   <li id="topbar-chat" class="hidden-xs"><a href="javascript:void(0)" data-step="4" data-intro="&lt;b&gt;Form chat&lt;/b&gt; keep you connecting with other coworker" data-position="left" class="btn-chat">Chat<i class="fa fa-comments"></i><span class="badge badge-info"><% //=olfriend_list.size() %></span></a></li> -->
            <li><a href="LogOutServlet?LoginType=Institute"><i class="glyphicon glyphicon-off"></i>Logout</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
                            ...
                            <div class="modal-body">
                                ...
                                <!--    <ul class="pull-left list-inline"><li><a href=""><i class="glyphicon glyphicon-upload"></i></a></li><li><a href=""><i class="glyphicon glyphicon-camera"></i></a></li><li><a href=""><i class="glyphicon glyphicon-map-marker"></i></a></li></ul> -->
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="hidden" class="form-control input-lg" name="InstituteId" id="InstituteId" value="<%=institute_id%>">
            ...
            <ul class="sidebar-nav" >
                ...
                <li class="dropdown" style="font-weight:bold;color:#c32929;">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="ViewGallery.jsp" style="font-weight:bold;color:#c32929;">View Gallery</a></li>  
                    <li class="divider"></li>
                    ...
                    <%                        
                      try{
                          ...
                          int blogId=0,likes=0,dislikes=0,uploadBy=0;count=0;
                            ...
                            sql="select * from instituteblog where InstituteId="+institute_id+" and (Privacy='Institute' or Privacy='Public') ORDER BY UploadDate";
                            ...
                            while(rs.next()){                 
                                ...
                                if(!(uploadBy!=0 && privacy.equalsIgnoreCase("OnlyMe")))  {   
                    %>
                                <div class="well">
