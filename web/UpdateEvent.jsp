...
@import url(http://fonts.googleapis.com/css?family=Lato:400,700);
    ...
    <script>
            ...
            function lockEventDetails()
            {
                ...
                document.getElementById('visible_level').readOnly=true;
            ...
            function showEventDetails()
            {
                ...
                document.getElementById('visible_level').readOnly=false;
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#"><span class="badge">Notifications</span></a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><p class="navbar-text">Logged in as <a><%= kalakar_name %></a><i class="glyphicon glyphicon-user"></i></p></li>
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    ...
                    <figure>
                        <center>
                              <img src="img1/profile_pic.png" alt="" class="img-circle img-responsive">
                        </center>
                    </figure>
                    </div>
                </li>
               ...
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="modal" data-target="#ViewEventModal">View Event</a></li>                    
                  </ul>
                </li>
                  <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="modal" data-target="#ViewExamModal">View Exam</a></li>                    
                  </ul>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="modal" data-target="#ViewCourseModal">View Course</a></li>                    
                  </ul>
                </li>
                <li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="modal" data-target="#ViewResultModal">View Result</a></li>
                    <li class="divider"></li>
            ...
            <div class="modal fade" id="UploadResultModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <!-- The form is placed inside the body of modal -->
                          <form class="form-horizontal" id="addEventForm" action="UploadResultServlet" method="post" >
                          <div class="form-group">
            ...
            <div class="container-fluid" >
                <div class="row">  
                    <div class="col-md-12" id="mainDiv" ><hr style="border-color: blueviolet">
                        <div class="jumbotron">
                            <form class="form-horizontal" action="UpdateEventServlet" method="post">
                                <div class="form-group form-group-sm">
                                      <label class="col-md-3 col-md-offset-4 lead">Event Details</label>
                                           <div class="col-md-2">
                                                 <input class="btn btn-md btn-default " type="button" value="Edit" onclick="showEventDetails();" > 
                                           </div>
                                </div>
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Event Title:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="event_name" name="event_name"  value="<%= ef.getEvent_name()%>" readOnly="true" required autofocus >
                            </div>
                          </div>                          
                          <div class="form-group">
                            <label for="city" class="col-sm-4 control-label">Enter Location:</label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="loc" name="location" placeholder="Enter Location" value="<%=ef.getLocation()%>" readOnly="true" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="date" class="col-sm-4 control-label">Starting Date:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="start_date" title="YYYY/MM/DD" name="start_date" placeholder="YYYY/MM/DD" value="<%= ef.getStartDate()%>" readOnly="true" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="date" class="col-sm-4 control-label">End Date:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="end_date" title="YYYY/MM/DD" name="end_date" placeholder="YYYY/MM/DD" value="<%= ef.getEndDate()%>" readOnly="true" required autofocus>
                            </div>
                          </div>    
                          <div class="form-group">
                            <label for="time" class="col-sm-4 control-label">Time:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="t" name="time" value="<%= ef.getTime() %>" readOnly="true" required autofocus>
                            </div>
                          </div>
                           <div class="form-group">
                            <label for="city" class="col-sm-4 control-label">Event Details:</label>
                            <div class="col-sm-4">
                                <textarea name="event_details" id="ed" required autofocus placeholder="<%=ef.getEventDetails()%>" readonly="true"></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="gender" class="col-sm-4 control-label">Select Visibility Level:</label>
                            <div class="col-sm-8">
                              <div class="btn-group" data-toggle="buttons">
                               <label class="btn btn-primary">
                                   <input type="radio" name="visible_level" id="visible_level" value="Public" > Public
                               </label>
                               <label class="btn btn-primary">
                                   <input type="radio" name="visible_level" id="visible_level" value="Institute"> Institute
                               </label>
                           </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                              ...
                              <button type="reset" class="btn btn-info" id="cancelBtn" onclick="lockEventDetails()">Cancel</button>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <input type="hidden" name="sendEventDetails" value="<%=ef.getEventDetails()%>"/>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <input type="hidden" name="created_by" value="<%=institute_id%>"/>
                            </div>
                          </div>  
                            </form>   
                        </div>                        
