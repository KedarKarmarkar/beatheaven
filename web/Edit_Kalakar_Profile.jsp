...
<html lang="en"><head>
        ...
        <title>Edit kalakar profile</title>
        <!-- Bootstrap Core CSS -->
          ...
          function hideKalakarDetails()
            {
                ...
                document.getElementById('playing_instrument').readOnly=true;
    ...
    <body style="background-image:url(img1/b46.png) ">
        <%! HttpSession session;%>
        ...
        <%   } else {
                ...
                session.setAttribute("LoginType", "Kalakar");
            }
        } catch (Exception e) {%>
        ...
        %>
        <div class="row">
            <nav class="navbar navbar-default navbar-fixed-top " style="background-color:#DFDACB;border-style: ridge">
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="" style="border-style: none ;background-color:#DFDACB;"><a href="Kalakar_Profile.jsp"><b>Kalakar Profile</b></a></li>
                            ...
                            <li><a href="#menu-toggle" class="btn  btn-sm" id="menu-toggle"><b>Toggle</b></a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="LogOutServlet?LoginType=Kalakar"><i class="glyphicon glyphicon-off"></i>Logout</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </div>
            </nav>
            <div class="" id="wrapper">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" action="AddPersonalBlogServlet" method="post">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="btn-group" role="group" >
                                                <div class="btn-group" data-toggle="buttons">
                                                    ...
                                                    <label class="btn btn-primary">
                                                        <input type="radio" name="txtPrivacy" id="option3"  value="OnlyMe">Personal 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control input-lg" name="txtaPostBody" id="txtaPostBody" autofocus="" placeholder="What do you want to share?" required autofocus></textarea>
                                        </div>
                                    </div>
                                    <hr class="style-two">
                                    <div><center>
                ...
                <li >               
                    <figure>
                        <center>
                            <a href="EditProfilePicForKalakar.jsp" title="click to Edit Profile Pic" > <img src="<%=profilepic_path%>" alt="" class="img-circle img-responsive" style="width:150px;height:125px"> </a>
                        </center>
                    </figure>                    
                </li>               
                <li><hr></li>
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row"><center>
                                <div class="jumbotron " style="float:center;background-image:url(img1/b46.png)" >
                                <center>
                                    <form class="form-horizontal" action="UpdateKalakarProfile" method="post">
                                        <div class="form-group form-group-sm">
                                            <label class="col-md-2 col-md-offset-4 lead"><b>Edit Profile</b></label>
                                            <div class="col-md-2">
                                                <input class="btn btn-md btn-info " type="button" value="Edit" onclick="showKalakarDetails();" > 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Name:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="name" name="name"  value="<%= k.kalakar_name%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Address:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="address" name="address"  value="<%=k.address%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">City:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="city" name="city"  value="<%=k.city%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Date of Birth</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="dob" name="dob"  value="<%=k.dob%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Email:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="email" name="email"  value="<%=k.email%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Contact:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="contact" name="contact"  value="<%=k.contact%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label">Interest:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="interest" name="interest"  value="<%=k.interest%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Playing Instruments:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="playing_instrument" name="playing_instrument"  value="<%=k.playing_instrument%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-4 control-label text-left">Occupation:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="occupation" name="occupation"  value="<%=k.occupation%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="col-sm-4 control-label text-left">Password:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="password" name="password"  value="<%=k.password%>" readOnly="true" required autofocus >
                                            </div>
                                        </div>    
                                        <div class="form-group">
                                            <label for="gender" class="col-sm-4 control-label text-left">Select Gender:</label>
                                            <div class="col-sm-4 ">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-sm-10 ">
                                            <button type="submit" class="btn btn-info" id="updateBtn" readOnly="true" >Update</button>
                                            <button type="reset" class="btn btn-info" id="cancelBtn" onclick="hidekalakarDetails()" >Cancel</button>
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-4 col-sm-8">
                                                <input type="hidden" name="kalakar_id" value="<%=kalakar_id%>"/>
                                            </div>
                                        </div>
                                    </form>
                                </center>
