...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>View Event By User</title>
    <!-- Bootstrap Core CSS -->
                            ...
                            ResultSet rs;
                               try{ 
                                   ...
                                   String cur_date=gcdt.getCurDate();
                                    ...
                                    sql="select * from eventinfo where CreatedBy="+institute_id+" and EndDate>='"+Date.valueOf(cur_date)+"'";
                              ...
                              <td><%=rs.getString("VisibilityLevel")%></td>
                           
                          </tr>
                                    <% }
                                    conn.close(); 
                                    if(count==0){%>
                                    <tr class="success"><td colspan="10"><center><b>No more upcoming events</b></center></td></tr>
                              <%} } catch(Exception ex){}
                         %>  
                      </tbody>
                    </table>
