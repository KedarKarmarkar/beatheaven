...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>View Institute Feedback</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row col-sm-12 "> <div class="col-sm-3"></div>
                    ...
                    <%
                        ...
                        <tbody>
                            ...
                            <input type="hidden" name="Id" value="<%=id%>"/>&nbsp;<input type="hidden" name="prevcomments" value="<%=f.getComments()%>"/>&nbsp;<input type="hidden" name="commentby" value="Institute"/> 
                       </center> 
                    </form>
                    </div>
                </div>
