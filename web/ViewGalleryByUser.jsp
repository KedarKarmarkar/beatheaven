...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>View Gallery By User</title>
    <!-- Bootstrap Core CSS -->
...
<%       // Set refresh, autoload time as 5 seconds
   ...
   String CT = hour+":"+ minute+" "+ am_pm;
    ...
    String msg="welcome",kalakar_name=""; 
                          ...
                          <div class="row " >
                            <div class="col-md-12">
                                <div class="container jumbotron col-md-12">
                                     <div class="col-md-12">
                                <form action="ViewGalleryByUser.jsp" method="post">
                                    <center>
                                        <b>Choose Event:</b>&nbsp;
                                        <select name="eventid">
                                            <%
                                        ...
                                        <br>
                                        <input type="submit" name="submitBtn" value="View Images"/>
                                    </center>
                                        <hr>
                                </form>
                            </div>
                             <div class="col-md-12">            
                                <form>
                                    <center><br>
                                        <table class="table table-bordered well-sm" style="width:350px;"><tr><td colspan="2">Search Results:</td></tr>
                                            <%
                                       try{         
                                                String file_loc="",title="",fname="",locationFolder="D:\\Data\\TYMCA\\SEM VI\\Beatheaven-Final Year Project\\BeatHeaven\\web\\img1\\event_images\\",newfile="";
                                                String path="";
                                               int image_count=0,image_id=0,icount=0;
                                               String submitBtn=request.getParameter("submitBtn");
                                                locationFolder = locationFolder + m.getName() + "\\";
                                                path="img1/event_images/"+m.getName()+"/";  
                                                 File folder = new File(locationFolder);
                                                 File[] listOfFiles = folder.listFiles();
                                               if(submitBtn.equalsIgnoreCase("View Images")){
                                                   Class.forName("com.mysql.jdbc.Driver");
                                                   Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/beatheaven", "root", "");
                                                   int eventId=Integer.parseInt(request.getParameter("eventid"));
                                                   Statement stmt = conn.createStatement();
                                                   String sql = "select  * from gallery where EventId=" + eventId + " and InstituteId=" + institute_id + "";
                                                   ResultSet rs = stmt.executeQuery(sql);
                                                   while (rs.next()) {
                                                      image_id=rs.getInt("Id");
                                                      title=rs.getString("ImageName");
                                                      file_loc=rs.getString("ImageLocation");
                                                      image_count=rs.getInt("ImageCount");
                                                   }
                                                   rs.close();
                                                   for (int i = 0; i < listOfFiles.length; i++) {
                                                        if (listOfFiles[i].isFile()) {
                                                                            fname = listOfFiles[i].getName();
                                                                            if(fname.substring(0, 1).equals(""+ eventId)) {
                                                                                icount++;
                                                                                newfile=path+fname;%>
                                                                                <tr>
                                                                                    <td style="width:250px;height:150px"><img src="<%=newfile%>"  class=" img-responsive" style="width:250px;height:150px"></td><td style="width:100px;height:150px"><%=title%>:<%=icount%></td>    
                                                                               </tr><%
                                                                            }
                                                        }
                                                   }
