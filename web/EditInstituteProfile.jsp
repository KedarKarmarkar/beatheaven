...
@import url(http://fonts.googleapis.com/css?family=Lato:400,700);
    ...
    <script>
        function showMaifalDetails()
            {
                document.getElementById('name').readOnly=false;
                document.getElementById('address').readOnly=false;
                document.getElementById('city').readOnly=false;
                document.getElementById('est_date').readOnly=false;
                document.getElementById('founder').readOnly=false;
                document.getElementById('activities').readOnly=false;
                document.getElementById('contact').readOnly=false;
                document.getElementById('email').readOnly=false;
                document.getElementById('regid').readOnly=false;
                document.getElementById('password').readOnly=false;
                document.getElementById('updateBtn').readOnly=false;
            }
          function hideMaifalDetails()
            {
                document.getElementById('name').readOnly=true;
                document.getElementById('address').readOnly=true;
                document.getElementById('city').readOnly=true;
                document.getElementById('est_date').readOnly=true;
                document.getElementById('founder').readOnly=true;
                document.getElementById('activities').readOnly=true;
                document.getElementById('contact').readOnly=true;
                document.getElementById('email').readOnly=true;
                document.getElementById('regid').readOnly=true;
                document.getElementById('password').readOnly=true;
                document.getElementById('updateBtn').readOnly=true;
            }  
    </script>    
</head>
<body>
...
<% // Set refresh, autoload time as 5 seconds
   ...
   ResultSet rs;
    ...
    try {
                session = request.getSession();
                if (session == null || session.isNew()) {  } else {
                    ...
                    session.setAttribute("LoginType", "Institute");
        }
    }catch(Exception e){%>
	...
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#DFDACB" >
      <div class="container">
        <div class="navbar-header" id="div1">
          ...
          <a class="navbar-brand" href="Institute_Profile.jsp" ><b>BEAT</b><span style="font-weight:bold;color:#c32929;">HEAVEN</span> </a>
        </div>
                ...
                <li >               
                    <figure>
                        <center>
                            ...
                            <a href="EditProfilePic.jsp" title="click to Edit Profile Pic" > <img src="<%=profilepic_path%>" alt="" class="img-circle img-responsive" style="width:150px;height:125px"> </a>
                        </center>
                    </figure>                    
                </li>               
                <li><hr></li>
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="examTime" name="examTime" placeholder="(e..g 1:00PM-3:00PM)" required autofocus>
                            </div>
                          </div>  
                          <div class="form-group">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="jumbotron">
                        <center>
                            <form class="form-horizontal" action="UpdateInstituteProfile" method="post">
                                <div class="form-group form-group-sm">
                                    <label class="col-md-3 col-md-offset-4 lead"><b><%=m.getName()%></b></label>
                                       <div class="col-md-2">
                                           <input class="btn btn-md btn-default " type="button" value="Edit" onclick="showMaifalDetails();" > 
                                       </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Name:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="name" name="name"  value="<%= m.getName() %>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                 <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Address:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="address" name="address"  value="<%= m.getAddress()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">City:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="city" name="city"  value="<%= m.getCity()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Establish Date:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="est_date" name="est_date"  value="<%= m.getEst_date()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Founder:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="founder" name="founder"  value="<%= m.getFounder()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Activities:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="activities" name="activities"  value="<%= m.getActivities()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Contact:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="contact" name="contact"  value="<%= m.getContact()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Email:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="email" name="email"  value="<%= m.getEmail()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">RegId:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="regid" name="regid"  value="<%= m.getRegid()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>                                     
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Password:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="password" name="password"  value="<%= m.getPassword()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                    
                                      <button type="submit" class="btn btn-info" id="updateBtn" readOnly="true" >Update</button>
                                      <button type="reset" class="btn btn-info" id="cancelBtn" onclick="hideMaifalDetails()" >Cancel</button>
