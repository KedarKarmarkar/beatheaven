                    ...
                    <div class="container-fluid">
                        ...
                        <form>
                            ...
                            <table class="table table-bordered">
                                <thead>
                          <tr class="active">
                              <th colspan="2">click to download the file</th>
                          </tr> 
                          </thead>
                      <tbody>
                                            <%
                                                ...
                                                for (int i = 0; i < listOfFiles.length; i++) {
                                                    if (listOfFiles[i].isFile()) {
                                                        ...
                                                        <tr><td colspan="2"><h5> <a href="/BeatHeaven/DownloadExamResult.jsp?filename=<%=fileName%>&filepath=<%=locationFolder%>"> <%=fileName%> </a></h5></td> </tr>
                                        <%         }
                                            }
