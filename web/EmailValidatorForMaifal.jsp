    ...
    <% String button="";
        ...
        if(button.equalsIgnoreCase("Verify")) {         
            ...
            if(count<3) {                
                ...
                random_code=m.getRandomCode(request.getParameter("email")); 
...
//if code matches enable table2 & diable table1 
                ...
                int i= m.deleteMaifal(request.getParameter("email"));                
           ...
           // Maifal m=new Maifal();
            int s=m.getUserNameAvailability(user_name);
            if(s==0 && !(user_name.equalsIgnoreCase("beatHEAVEN"))) {
                if(password.equalsIgnoreCase(cpassword) && rc.equals(enterrc)){                   
                     email_id=request.getParameter("emailid");                    
                     int i= m.updateMaifalInfo(email_id,user_name , password);
                     if(i==1){
                         msg_login="Registration process completed..<a href='index.jsp'>Go Home</a>";
                         msg_login+="<br> You will Receive Email Notification for Approval of your request shortly..<br>(Please confirm that you have paid the registration fees..if any queries contact @ beatHeaven_admin@gmail.com)Thanks!!";                         
                    ...
                    msg_login="Character not match..password does not matched,try again";
                    msg_login +=" Click to <input type='button' name='continue' value='Enter Details' onClick='resetTables();'/> ";
                    email_id=request.getParameter("emailid");
                }
            }else{
...
<div id="templatemo_container_wrapper">
    <div id="templatemo_container">
        ...
        <div id="templatemo_content">
                <center>
                <h3>Welcome to Maifal Registration</h3>
                
                    <div>
                        <form class="form-vertical" role="form" name="codeverifierform" action="EmailValidatorForMaifal.jsp" method="post"><br>
                            ...
                            <table  id="table1" >
                                ...
                                <tr><td><button class="btn btn-sm btn-primary btn-block" type="submit" name="submit" value="Verify">Verify</button></td>
                                    <td><button class="btn btn-sm btn-primary btn-block" type="clear">clear</button></td></tr>
                            </table>
                                <input type="hidden" name="count" value="<%=count%>"/>
                                <br><br><hr> 
                        </form>
                                <form class="form-vertical" role="form" name="logindetailsform" action="EmailValidatorForMaifal.jsp" method="post">
