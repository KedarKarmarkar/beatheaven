    ...
    <div class="" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <form action="ManageInstituteAccessibilityAction.jsp" method="post">
                        <center><br><br><center></center>
                            <table class=" table-condensed table-striped table-bordered">
                                <tr class="denger"> <td colspan="2"><center><h4><b>Manage Accessibility</b></h4></center></td></tr>
                                <tr><td style="float: right"> Select Name:&nbsp;&nbsp;</td>
                                <td>
                                        <select name="user_id">
                                            <%
                                                 bdc.kalakarIdList.clear();
                                                int j= bdc.getInstituteNotificationCount(institute_id);
                                                for(int i=0;i<bdc.kalakarIdList.size();i++){%>
                                                    <option value="<%=bdc.kalakarIdList.get(i)%>"><%=k.getKalakarName(bdc.kalakarIdList.get(i))%></option>
                                               <% }
                                            %>
                                        </select> 
                                </td></tr>                                 
                                <tr><td colspan="2">
                                <center><input type="submit" name="submit" value="Get Details"/></center>                         
                                    </td></tr>
                            </table>
                        </center>
                        </form>    
