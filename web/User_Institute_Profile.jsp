...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>User_Institute View</title>
    <!-- Bootstrap Core CSS -->
...
<%       // Set refresh, autoload time as 5 seconds
   ...
   String CT = hour+":"+ minute+" "+ am_pm;
    ...
    int institute_id=1;
 //   institute_id=Integer.parseInt(request.getParameter("InstituteId"));
   ...
   <% }
    ...
    olfriend_list=ou.getOnlineFriendDetails(kalakar_id);
    ...
    String dir=kalakar_id+"_Kalakar";
...
<div class="row">
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:pink;" >
      <div class="container">
        <div class="navbar-header" id="div1">
          ...
          <a class="navbar-brand" href="Kalakar_Profile.jsp" ><b>BEAT</b>
                   <span style="font-weight:bold;color:#c32929;">HEAVEN</span> </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li class="active"><a href="Institute_Profile_Home.jsp"><span style="font-weight:bold;color:#28a4c9;" ><b><%= m.getName()%></b></span></a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
              <li><p class="navbar-text">Logged in as <a href="Edit_Kalakar_Profile.jsp"><%=k.getKalakarName(kalakar_id)%></a></p></li>
            ...
            <li><a href="Kalakar_Profile.jsp"><i class="glyphicon glyphicon-off"></i>Back to Home</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <div id="sidebar-wrapper" style="background-color:#245269;font-weight:bold;color:#c32929;" > 
            <ul class="sidebar-nav" >
                ...
                <li class="dropdown" style="font-weight:bold;color:#c32929;">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">View Uploads<b class="caret"></b></a>
                  <ul class="dropdown-menu" role="menu">                    
                    <li><a href="ViewResultByUser.jsp" style="font-weight:bold;color:#c32929;">View Result</a></li>
                    <li class="divider"></li>                    
                    <li><a href="ViewGalleryByUser.jsp" style="font-weight:bold;color:#c32929;">View Gallery</a></li>  
                    <li class="divider"></li>                    
                    <li><a href="ViewMediaByUser.jsp" style="font-weight:bold;color:#c32929;">View Media</a></li>  
                  </ul>
                </li>
               <li class="dropdown" style="font-weight:bold;color:#c32929;">
                  <a href="" class="dropdown-toggle" data-toggle="dropdown" >Event Management<b class="caret"></b></a>
                  <ul class="dropdown-menu" role="menu">                    
                    <li><a href="ViewEventByUser.jsp" style="font-weight:bold;color:#c32929;">View Event</a></li>                    
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="" class="dropdown-toggle" data-toggle="dropdown">Exam Management<b class="caret"></b></a>
                  <ul class="dropdown-menu" role="menu">                    
                    <li><a href="ViewExamByUser.jsp" style="font-weight:bold;color:#c32929;">View Exam</a></li>                    
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="" class="dropdown-toggle" data-toggle="dropdown">Course Management<b class="caret"></b></a>
                  <ul class="dropdown-menu" role="menu">                    
                    <li><a href="ViewCourseByUser.jsp" style="font-weight:bold;color:#c32929;">View Course</a></li>                    
                  </ul>
                </li>                
                <li  class="dropdown">
                          ...
                          <form class="form-horizontal" id="AddInstitutFeedBackForm" action="AddInstitutFeedBack" method="post">
                             <div class="form-group">
                                <%
                                    ...
                                    int s=fb.getFeedBackByID(kalakar_id,institute_id);
                                %>
                               <table class="table table-bordered">
                                ...
                                <tbody>
                                    <% if(fb.count>0){ %>
                                    <tr class="success">
                                         <td><%=fb.getUser_name()%></td>
                                         <td><%=fb.getCategory()%></td>
                                         <td><%=fb.getSubject()%></td>
                                         <td><%=fb.getPost_date()%></td>
                                         <td><a href="ViewInstituteFeedBackDetailsByUser.jsp?Id=<%=fb.getId()%>">View Details</a></td>                                         
                                    </tr>
                                    <% }else{ %>
                      ...
                      <div class="modal-body active">                         
                              <%                              
                                for (int i = 0; i < bdc.bdayIdList.size(); i++) {
                                    String birthdaywishdate=bdc.getBirthDayWishDate(bdc.bdayIdList.get(i), kalakar_id, "Kalakar");
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body active">
                            ...
                            <% }
                            int updateStatus= bdc.updateLast_Seen(kalakar_id, "Kalakar");
                          %>
                      </div>                      
                      </form>                           
                  </div>
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="time" class="form-control" id="time" name="time" placeholder="time" required autofocus>
                            </div>
                          </div>  
                          <div class="form-group">
                 ...
                 <div class="row col-lg-12">
                    ...
                    <%                        
                      try{
                          ...
                          String sql="";
                          ResultSet rs;
                          String title="",subject="",body="",file_loc="",privacy="",ref="",post_date="";
                          int blogId=0,likes=0,dislikes=0,uploadBy=0;count=0;
                            Class.forName("com.mysql.jdbc.Driver");     
                            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/beatheaven", "root", "");              
                            stmt = conn.createStatement(); 
                            //sql="select * from instituteblog where InstituteId="+institute_id+" and (Privacy='Institute' or Privacy='Public') ORDER BY(DESC(uploaddate))";
                            sql="select * from instituteblog where InstituteId="+institute_id+" ORDER BY UploadDate";
                            ...
                            while(rs.next()){                 
                                ...
                                file_loc=rs.getString("ImageLocation");
                                ref=rs.getString("Reference");
                                uploadBy=rs.getInt("UploadBy");
                                post_date=rs.getDate("UploadDate").toString();
                                likes=rs.getInt("Likes");
                                dislikes=rs.getInt("Dislikes");
                                if(!(uploadBy!=kalakar_id && privacy.equalsIgnoreCase("OnlyMe")))  {   
                    %>
                                <div class="well">
                                    <div class="well-head nav">
                                        <h2><%=title%></h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;<%=k.getKalakarName(uploadBy)%>&nbsp;<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>&nbsp;Upload At:&nbsp;<%=post_date%>&nbsp;
                                        
                                        <% if(uploadBy==kalakar_id) {%>                                        
                                        <ul class=" col-sm-2 ">
                                                       <li class="dropdown">
                  <a href="" class="dropdown-toggle" data-toggle="dropdown"><%=privacy%><b class="caret"></b></a>
                  <ul class="dropdown-menu small" role="menu">
                      
                      <li ><a href="EditBlog?Id=<%=blogId%>&Type=instituteblog&Param=privacy&Value=Public">Public</a></li>
                    <li ><a href="EditBlog?Id=<%=blogId%>&Type=instituteblog&Param=privacy&Value=Institute">Institute</a></li>
                     <li ><a href="EditBlog?Id=<%=blogId%>&Type=instituteblog&Param=privacy&Value=OnlyMe">Only Me</a></li>
                  </ul></li></ul>
                                    ...
                                    <hr class="style-two">
                                    <div class="well-body">
                       <%         if(file_loc.equals("Unavailable")) { %>
                                        <%=body%>        
                       <%
                                }else{
                                 int   index=file_loc.lastIndexOf("/");
                                    profilepic_name= file_loc.substring(index+1);
                                    profilepic_path="img1/InstituteBlogImages/"+m.getName()+"/"+profilepic_name; 
                     %>
                     <center>
                        <img src="<%=profilepic_path%>" class="img-responsive" style="height: 150px;width:350px "/>  <hr class="style-two"> <%=body%>
                     </center>                   
                     <%         }%>
                                </div>
                                    <hr class="style-two">
                                    <div class="well-footer text-center">    
                                        <h4><a href="EditBlog?Id=<%=blogId%>&Type=instituteblog&Param=like&Value=<%=likes%>"><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true">:<%=likes %></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="EditBlog?Id=<%=blogId%>&Type=instituteblog&Param=dislike&Value=<%=dislikes%>"><span class="glyphicon glyphicon-thumbs-down" aria-hidden="true">:<%=dislikes %></span></a></h4>
                                    </div>
                                </div>
                           <% }
                            }
