	...
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#DFDACB">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">beatHeaven <%=isStatus%></a>
        </div>
               ...
               <li class="dropdown">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="ViewCourse.jsp" data-toggle="modal" data-target="">Manage Access</a></li>                    
                  </ul>
                </li>
                <li>
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body active">
                              ...
                              <i><a id="bl" href="BirthdayWishes.jsp?Id=<%=bdc.bdayIdList.get(i)%>"><%=k.getKalakarName(bdc.bdayIdList.get(i))%></a></i>,
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p><img src="E:\imgg.jpg"/></p>
                        <p>This template has a responsive menu toggling 
system. The menu will appear collapsed on smaller screens, and will 
appear non-collapsed on larger screens. When toggled using the button 
