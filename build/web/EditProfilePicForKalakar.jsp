...
<% // Set refresh, autoload time as 5 seconds
   ...
   ResultSet rs;
    ...
    String msg="welcome",kalakar_name="Admin",login_type=""; 
   ...
   // m.getMaifalDetails(institute_id);
    ...
    if(login_type.equalsIgnoreCase("Institute"))
     count=ppd.getProfilePicDetails(institute_id, "Institute");
    else if(login_type.equalsIgnoreCase("Kalakar"))
     count=ppd.getProfilePicDetails(kalakar_id, "Kalakar");
