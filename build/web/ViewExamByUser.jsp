                        ...
                        <%      
                               ...
                               try{ 
                                   ...
                                   String cur_date=gcdt.getCurDate();
                                    ...
                                    sql="select * from exam where ConductedBy="+institute_id+" and ExamDate>='"+Date.valueOf(cur_date)+"' and Status=1";
                                    rs = stmt.executeQuery(sql); 
                                    while(rs.next()){
                                        exam_id=rs.getInt("Id");
                                        count++;
                                        %>
                                        <tr class="success">
                              <td><%=exam_id%></td>
                              ...
                              <td><%=rs.getString("Eligibility")%></td>
                                    ...
                                    conn.close(); 
                                    if(count==0){%>
                                    <tr class="success"><td colspan="10"><center><b>No more upcoming exam schedules available</b></center></td></tr>
                              <%} } catch(Exception ex){}
                         %>  
                      </tbody>
                    </table>
