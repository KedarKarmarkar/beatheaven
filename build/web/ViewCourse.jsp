                        ...
                        <%
                               try{ 
                                   ...
                                   String cur_date=gcdt.getCurDate();
                                    ...
                                    String sql="select * from course where InstituteId="+institute_id+" and Status=1";
                              ...
                              <td><a href="UpdateCourse.jsp?CourseId=<%=course_id%>">Update</a></td>
                              <td><a href="DeleteCourse?CourseId=<%=course_id%>">Delete</a></td>
                          </tr>
                                    <% }
                                    conn.close(); 
                                    if(count==0){%>
