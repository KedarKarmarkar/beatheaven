                                            ...
                                            <%
                                                ...
                                                for (int i = 0; i < listOfFiles.length; i++) {
                                                    if (listOfFiles[i].isFile()) {
                                                        ...
                                                        <tr><td><h5> <a href="/BeatHeaven/DownloadExamResult.jsp?filename=<%=fileName%>&filepath=<%=locationFolder%>"> <%=fileName%> </a></h5></td><td><a href="DeleteResultFile?filename=<%=fileName%>&filepath=<%=locationFolder%>"><button type="button" class="btn btn-info">Delete File</button></a></td></tr>
                                        <%         }
                                            }
