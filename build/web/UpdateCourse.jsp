            ...
            <div class="container-fluid" >
                <div class="row">  
                    <div class="col-md-12" id="mainDiv" ><hr style="border-color: blueviolet">
                        <div class="jumbotron">
                            <form class="form-horizontal" action="UpdateCourseServlet" method="post">
                                <div class="form-group form-group-sm">
                                      <label class="col-md-3 col-md-offset-4 lead">Course Details</label>
                                           <div class="col-md-2">
                                                 <input class="btn btn-md btn-default " type="button" value="Edit" onclick="showCourseDetails()" > 
                                           </div>
                                </div>                                   
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Course Name:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="course_name" name="course_name" placeholder="Course Name" value=<%=c.getCourse_name()%> readOnly="true" required autofocus>
                            </div>
                          </div>                          
                          <div class="form-group">
                            <label for="city" class="col-sm-4 control-label">Enter Duration:</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="d" name="duration" readOnly="true" value="<%=c.getDuration()%>"  required autofocus>
                            </div>
                          </div>                          
                          <div class="form-group">
                            <label for="time" class="col-sm-4 control-label">Fee:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="f" name="fee" placeholder="(enter per month amount:in digits)" readOnly="true" value="<%=c.getFee()%>" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="city" class="col-sm-4 control-label">Eligibility:</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="e" name="eligibility" placeholder="eligibility" readOnly="true" value="<%=c.getEligibility()%>" required autofocus>
                            </div>
                          </div> 
                          <div class="form-group">
                            <label for="city" class="col-sm-4 control-label">Specification(Note):</label>
                            <div class="col-sm-8">
                                <textarea name="specification" id="s" placeholder="<%=c.getSpecification()%>" readonly="true" ></textarea>
                            </div>
                          </div>    
                            <hr class="style-two">
                          <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                              <button type="submit" class="btn btn-info" id="submit" readOnly="true" >Submit</button>
                              <button type="reset" class="btn btn-info">Cancel</button>
                            </div>
                          </div>
                          <div class="form-group">                            
                          ...
                          <div class="form-group">                            
                            <div class="col-sm-8">
                              <input type="hidden" class="form-control" id="spec" name="courseInfo" value="<%=c.getSpecification()%>">
                            </div>
                          </div>  
                            </form>   
                        </div>                        
