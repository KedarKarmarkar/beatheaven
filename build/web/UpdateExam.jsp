...
@import url(http://fonts.googleapis.com/css?family=Lato:400,700);
    ...
    <script>
            ...
            function showExamDetails()
            {
                ...
                document.getElementById('exam_name').readOnly=false;
                ...
                document.getElementById('exam_type').readOnly=false;
                document.getElementById('eligi').readOnly=false;
...
<%  
    ...
    int exam_id=0;
    exam_id=Integer.parseInt(request.getParameter("ExamId"));
    int institute_id=1;    
    int kalakar_id=0;
    Connection conn;
    Statement stmt;
    ...
    try {
      ...
      <h5> Error while session loading..<%=ex.getMessage()%></h5>          
   <% }
    Course c=new Course();
    coursename_list=c.getCourseName(institute_id);
     ArrayList<Integer> examid_list = new ArrayList<Integer>();
     Exam exam=new Exam();
     //examid_list=exam.getExamId(institute_id);
     exam.getExamInfo(exam_id);
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="ename" name="event_name" value="" placeholder="Event Name" required autofocus>
                            </div>
                          </div>                          
                          <div class="form-group">
            ...
            <div class="container-fluid" >
                <div class="row">  
                    <div class="col-md-12" id="mainDiv" ><hr style="border-color: blueviolet">
                        <div class="jumbotron">
                            <form class="form-horizontal" action="UpdateExamServlet" method="post">
                                <div class="form-group form-group-sm">
                                      <label class="col-md-3 col-md-offset-4 lead">Exam Details</label>
                                           <div class="col-md-2">
                                                 <input class="btn btn-md btn-default " type="button" value="Edit" onclick="showExamDetails();" > 
                                           </div>
                                </div>
                                <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Exam Id:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="exam_id" name="exam_id" value="<%= exam.getExam_id() %>" readOnly="true" required autofocus>
                            </div>
                          </div>  
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Course Id:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="course_id" name="course_id" value="<%= exam.getCourse_id()%>" readOnly="true" required autofocus>
                            </div>
                          </div>    
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Exam Title:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="exam_name" name="exam_name" value="<%= exam.getExam_name()%>" readOnly="true" placeholder="Exam Name" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Exam Date:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="examdate" name="exam_date" value="<%= exam.getDate()%>" readOnly="true" placeholder="Exam Date" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Time</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="t" name="time" value="<%= exam.getTime()%>" placeholder="time" readOnly="true" required autofocus>
                            </div>
                          </div>  
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Location:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="loc" name="location" value="<%= exam.getLocation()%>" readOnly="true" placeholder="Location" required autofocus>
                            </div>
                          </div>  
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Type:</label>
                            <div class="col-sm-8">
                                <select name="exam_type" id="exam_type"><option value="Multichoice">MultiChoice</option><option value="Subjective">Subjective</option></select>
                            </div>
                          </div> 
                          <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Eligibility:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="eligi" name="eligibility" value="<%= exam.getEgligibility()%>" readOnly="true" placeholder="Eligibility" required autofocus>
                            </div>
                          </div>
                            <hr class="style-two">
                          <div class="form-group">
