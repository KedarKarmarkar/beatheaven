      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><p class="navbar-text">Logged in as <a href="EditProfile.jsp"><%= m.getName()%></a></p></li>
            ...
            <ul class="sidebar-nav" >
                ...
                <li class="dropdown" style="font-weight:bold;color:#c32929;">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="modal" data-target="#ViewMediaModal" style="font-weight:bold;color:#c32929;">View Media</a></li>  
                  </ul>
                </li>
               <li class="dropdown" style="font-weight:bold;color:#c32929;">
        ...
        <!-- page content -->
         <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <form  action="UploadEventImage" method="post" enctype="multipart/form-data" >
                        <div class="form-group">
                            <center>
                                <br><br><br><br>
                                <table style="border-style: inherit" > 
                                    <tr> <td colspan="3"><center><b><u>Choose Image File(.jpeg/.gif/.png) to Upload</u></b></center><br></td></tr>
