<%@page import="BeatHeaven_Classes.SiteAdmin"%>
...
<html lang="en">
    ...
    <body>
        ...
        <% }
            ...
            SiteAdmin sa=new SiteAdmin();
            sa.getSiteAdminDetails(siteAdminId);
        %>
        <script>
        ...
        <div class="row">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><p class="navbar-text">Logged in as <a href="EditSiteAdminProfile.jsp?Id=<%=siteAdminId%>">BeatHeaven</a></p></li>
            ...
            <div class="" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="jumbotron">
                        <center>
                            <form class="form-horizontal" action="UpdateBHProfile" method="post">
                                <div class="form-group form-group-sm">
                                    <label class="col-md-3 col-md-offset-4 lead"><b>BEATHEAVEN</b></label>
                                       <div class="col-md-2">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="contact" name="contact"  value="<%= sa.getContact()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Email:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="email" name="email"  value="<%= sa.getEmail()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>                                                                   
                                <div class="form-group">
                                      <label for="name" class="col-sm-4 control-label">Password:</label>
                                      <div class="col-sm-4">
                                          <input type="text" class="form-control" id="password" name="password"  value="<%= sa.getPassword()%>" readOnly="true" required autofocus >
                                      </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        <input type="hidden" name="siteAdminId" value="<%=siteAdminId%>"/>
                                    </div>
                               </div>
                            </form>
                        </center>
