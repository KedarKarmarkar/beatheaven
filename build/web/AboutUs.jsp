    ...
    <div class="container" >
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control bootstrap-datetimepicker-widget date" id="dob" name="dob" placeholder="YYYY/MM/DD" required autofocus>
                            </div>
                          </div>
                          <div class="form-group">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control bootstrap-datetimepicker-widget" id="dob" name="edate" placeholder="YYYY/MM/DD" required autofocus>
                            </div>
                          </div>
                           <div class="form-group">
      ...
      <div class="" id="wrapper">
       <div id="page-content-wrapper">
        ...
        <div class="row" >
      <!--      <div class="col-lg-12 panel panel-primary" style="border-style: none"> -->
            <div class="col-lg-4 panel panel-primary " style="border-right-style:groove;margin: 0px;background-color: #E8931E">
                
                    <center> <h3>Mobile App</h3><br>
                    
                    User Can also Installed The Mobile App version<br>
                    Click bellow to download mobile app<br><br>
                        
                            <figure>
                                <center>
                                    <a href="MobileAppDownloader.jsp" >  <img src="img1/1_Institute.jpg" alt="" title="click to download" class="img-circle img-responsive" style="width:150px;height:125px"> </a>
                                </center>
                            </figure> 
                    <footer class="footer text-center">
          <p><font color="black">DevelopedBy:<B>©NK Developers</b></font></p>
      </footer>
                        
                    </center>
                
            </div>
                <div class="col-lg-8 panel panel-primary" style="border-style:none;margin: 0px;background-color: #E09D6D">                
                    <center><h3 >Terms and Conditions</h3></center><br>                 
                      <ul>
                          <li>The Kalakar(User) has to make registration to site which is free.<br><br></li>
                          <li>For Maifal(Institute) registration  charges are Rs.1000 per year<br><br></li>                          
                          <li>Once get registered you can download Mobile App & can view and get updated with different event notification & details<br><br></li>
                          <li>For any queries please contact <b>beatHeaven_admin@gmail.com</b><br><br></li>
                          <li>You can also request for adding the advertiements or details regarding your institute/event update<br><br></li>
                          <li><b>Note:Posting of any copyrighted prevented or illegal information through this site/application is strictly prohibited.If posted then it will be fully that 
                                  users/institutes responsibility who is going to post it,site admin will not be responsible for such cases.</b></li>                        
                      </ul>  <br><br>
            </div>            
    <!--    </div> -->
      </div>
